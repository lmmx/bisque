...
from bisque.builder.core.features import FAST, HTML, PERMISSIVE, XML
from bisque.builder.core.html_builder import HTMLTreeBuilder
from bisque.builder.core.main import ParserRejectedMarkup, TreeBuilder
from bisque.builder.core.parser_names import LXML, LXML_HTML, LXML_XML
from bisque.builder.core.xml import DetectsXMLParsedAsHTML
from bisque.dammit import EncodingDetector
...
class LXMLTreeBuilderForXML(TreeBuilder):
    ...
    def initialize_soup(self, soup):
        """Let the Bisque object know about the standard namespace
        mapping.
    ...
    def _register_namespaces(self, mapping):
        """Let the Bisque object know about namespaces encountered
    ...
    def start(self, name, attrs, nsmap={}):
        ...
        if len(nsmap) == 0 and len(self.nsmaps) > 1:
            ...
            # First, Let the Bisque object know about it.
