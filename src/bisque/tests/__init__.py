...
from bisque.builder._htmlparser import HTMLParserTreeBuilder
from bisque.builder.core import XMLParsedAsHTMLWarning
...
class SoupTest:
    ...
    def soup(self, markup, **kwargs):
        """Build a Bisque object from markup."""
        builder = kwargs.pop("builder", self.default_builder)
        return Bisque(markup, builder=builder, **kwargs)
    ...
    def assert_soup(self, to_parse, compare_parsed_to=None):
        """Parse some markup using Bisque and verify that
        the output markup is as expected.
        """
        builder = self.default_builder
        obj = Bisque(to_parse, builder=builder)
        ...
        # Also run some checks on the Bisque object itself:
...
class HTMLTreeBuilderSmokeTest(TreeBuilderSmokeTest):
    ...
    def test_pickle_and_unpickle_identity(self):
        ...
        assert loaded.__class__ == Bisque
...
<body>Goodbye.</body>
    ...
    def test_deepcopy(self):
        ...
        Bisque object, and we want to be able to copy that.
        """
...
"""
    ...
    # Bisque than tests of the tree builders. But parsers are
    ...
    def test_closing_tag_with_no_opening_tag(self):
        # Without Bisque.open_tag_counter, the </span> tag will
