...
def is_bisque_tag(cls, obj: PageElement) -> bool:
    """Is tag."""
    return isinstance(obj, Tag)


patch("soup_sieve.css_match._DocumentNav.is_tag", is_bisque_tag)
...
"""
    ...
    def setup_method(self):
        self.soup = Bisque(self.HTML, "html.parser")
    ...
    def test_select_duplicate_elements(self):
        ...
        soup = Bisque(markup, "html.parser")
