"""Tests of the bisque.element.PageElement class"""
import copy
import pickle
import sys
...
"""
        encoded = Bisque(doc, "html.parser").encode()
...
"""
    ...
    def test_prettify_accepts_formatter_function(self):
        soup = Bisque("<html><body>foo</body></html>", "html.parser")
...
<title>Bisque: We called him Tomato because he hung out in vineyards.</title>
<link rev="made" href="mailto:louismmx@gmail.com">
<meta name="Description" content="Bisque: A condensed web scraping library.">
