...
class TestConstructor(SoupTest):
    ...
    def test_custom_builder_class(self):
        ...
        # to the Bisque constructor are ignored.
        builder = Mock(**kwargs)
        ...
        assert msg.startswith(
            "Keyword arguments to the Bisque constructor will be ignored.",
        )
    ...
    def test_cdata_list_attributes(self):
        ...
        # by passing in a keyword argument to the Bisque constructor.
...
class TestOutput(SoupTest):
    ...
    def test(self):
        # Bisque subclasses Tag and extends the decode() method.
...
class TestWarnings(SoupTest):
    # Note that some of the tests in this class create Bisque
    ...
    def _assert_no_parser_specified(self, w):
        ...
        assert message.startswith(Bisque.NO_PARSER_SPECIFIED_WARNING[:60])
    ...
    def test_resembles_filename_warning(self, extension):
        ...
        with warnings.catch_warnings(record=True) as w:
            soup = Bisque("markup" + extension, "html.parser")
...
class TestNewTag(SoupTest):
    """Test the Bisque.new_tag() method."""
...
class TestNewString(SoupTest):
    """Test the Bisque.new_string() method."""
...
class TestPickle(SoupTest):
    # Test our ability to pickle the Bisque object itself.
...
class TestEncodingConversion(SoupTest):
    # Test Bisque's ability to decode and encode from various
    # encodings.
