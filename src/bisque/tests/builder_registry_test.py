...
from bisque.builder import HTMLParserTreeBuilder, TreeBuilderRegistry
from bisque.builder import builder_registry as registry

from . import HTML5LIB_PRESENT, LXML_PRESENT

if HTML5LIB_PRESENT:
    from bisque.builder import HTML5TreeBuilder
...
class TestBuiltInRegistry:
    ...
    def test_bisque_constructor_does_lookup(self):
        with warnings.catch_warnings(record=True) as w:
            # This will create a warning about not explicitly
            # specifying a parser, but we'll ignore it.

            # You can pass in a string.
            Bisque("", features="html")
            # Or a list of strings.
            Bisque("", features=["html", "fast"])
            pass

        # You'll get an exception if BS can't find an appropriate
        # builder.
        with pytest.raises(ValueError):
            Bisque("", features="no-such-feature")
