"""Tests for Bisque's tree traversal methods.

The tree traversal methods are the main advantage of using Beautiful
Soup over just using a parser.

Different parsers will build different Bisque trees given the
same markup, but all Bisque trees can be traversed with the
methods tested here.
"""
...
class TestTreeModification(SoupTest):
    ...
    def test_insert_bisque_object_inserts_children(self):
        """Inserting one Bisque object into another actually inserts all
        of its children -- you'll never combine Bisque objects.
        """
        ...
        for i in soup.descendants:
            assert not isinstance(i, Bisque)
    ...
    def test_consecutive_text_nodes(self):
        ...
        # but if you insert one next to another, Bisque will
        # handle it correctly.
